...
const mockShellRequests = () => {
  vi.spyOn(globalThis, "fetch").mockImplementation(async (input, init) => {
    ...
    if (url.endsWith("/api/ui-state") && method === "GET") {
      // El test verifica que strip y telemetry tape rendericen.
      // Con los defaults nuevos (modo consultor) están ocultos, así que
      // el mock los habilita explícitamente para preservar la cobertura.
      return defaultUiStateResponse({
