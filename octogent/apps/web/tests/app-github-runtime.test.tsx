...
const mockGithubRuntimeRequests = () => {
  vi.spyOn(globalThis, "fetch").mockImplementation(async (input, init) => {
    ...
    if (url.endsWith("/api/ui-state") && method === "GET") {
      // Modo consultor oculta el strip por default; el test lo habilita
      // explícitamente para verificar el render del github sparkline.
      return defaultUiStateResponse({ isRuntimeStatusStripVisible: true });
    }
