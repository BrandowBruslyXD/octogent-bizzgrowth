...
const mockAppRequests = (
  ...
  return vi.spyOn(globalThis, "fetch").mockImplementation(async (input, init) => {
    ...
    if (url.endsWith("/api/ui-state") && method === "GET") {
      // Modo consultor oculta runtime strip por default; este test
      // verifica el render del strip junto con el setup card, así que
      // habilitamos los toggles relevantes de forma explícita.
