...
// Modo Consultor BizzGrowth: defaults agresivos para minimizar ruido visual.
// El operador puede reactivar cualquiera desde Settings (tab 8).
const DEFAULT_IS_AGENTS_SIDEBAR_VISIBLE = false;
const DEFAULT_IS_ACTIVE_AGENTS_SECTION_EXPANDED = true;
const DEFAULT_IS_RUNTIME_STATUS_STRIP_VISIBLE = false;
const DEFAULT_IS_MONITOR_VISIBLE = false;
const DEFAULT_IS_BOTTOM_TELEMETRY_VISIBLE = false;
