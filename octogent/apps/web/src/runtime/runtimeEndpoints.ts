...
// El URL es el mismo para GET (leer archivo) y DELETE (borrar archivo).
// El backend distingue por método. El reset del modo Consultor usa DELETE
// sobre los 4 archivos de output.
