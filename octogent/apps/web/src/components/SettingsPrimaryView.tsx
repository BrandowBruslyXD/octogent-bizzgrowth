...
type SettingsPrimaryViewProps = {
  ...
  onShowingNonConsultorTentaclesChange: (visible: boolean) => void;
};
...
export const SettingsPrimaryView = ({
  ...
  onShowingNonConsultorTentaclesChange,
  ...
  <section className="settings-view" aria-label="Settings primary view">
    ...
    <section className="settings-panel" aria-label="Workspace surface visibility settings">
      ...
      <div className="settings-toggle-grid">
        ...
        />
        <SettingsToggle
          label="Mostrar tentáculos de desarrollo"
          description="Incluir en el canvas los tentáculos que no pertenecen al flujo consultor"
          ariaLabel="Mostrar tentáculos de desarrollo"
          checked={isShowingNonConsultorTentacles}
          onChange={onShowingNonConsultorTentaclesChange}
        />
      </div>
    </section>
  </section>
