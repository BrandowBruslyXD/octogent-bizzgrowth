...
// Borrar archivo de output de un tentacle (usado por el reset del modo
// Consultor para limpiar interview.json / current-flow.md / ideal-flow.md
// / propuesta.md y reiniciar el flujo). Devuelve true si el archivo
// existía y fue borrado, false si no existía o no se pudo borrar.
export const deleteDeckVaultFile = (
  workspaceCwd: string,
  tentacleId: string,
  fileName: string,
): boolean => {
