...
type StartupPrerequisiteSeverity = "error" | "warning";

type StartupPrerequisiteIssue = {
  command: string;
...
type StartupPrerequisiteAvailability = Record<"claude" | "codex" | "git" | "gh" | "curl", boolean>;

type StartupPrerequisiteReport = {
